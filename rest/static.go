...
func InitStaticRouterEx(r *mux.Router, staticDir, staticETag string,
	...
	staticRoutes := []string{
		...
		"/static/lib/angular/angular.min.js.map",
		...
		"/static/lib/angular-route/angular-route.min.js.map",
		...
		"/static/modal/window.html",
		"/static/partials/index/",
		...
		"/static/partials/index/tab-manage.html",
